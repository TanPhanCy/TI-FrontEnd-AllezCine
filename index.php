                ...
                <div class="library-featured-col">
  					...
  					<ul class="more-movies">
  						<li class="more-movies">
  							<button id="showMoreMovies" data-more="#more-featured-movies">Plus DE FILMS</button>
  						</li>
  					</ul>
  				</div>
  				...
  				<div class="container">
  					...
  					<ul class="more-movies">
  						<li class="more-movies">
                <button id="showMoreSeries" data-more="#more-featured-series">Plus DE SERIES</button>
  						</li>
  					</ul>
  				</div>
